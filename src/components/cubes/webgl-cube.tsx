...
import { WebGlCanvas, WebGlContextLevel } from "../common/WebGlCanvas";
import { IReactCubeProps } from "./generic-cube";

export const WebGlCube: React.FC<
  Omit<IReactCubeProps, "renderStyle">
> = props => {
  const vsSource = `
  ...
  return (
    <WebGlCanvas
      level={WebGlContextLevel.Level1}
      width={1024}
      height={512}
...
function initBuffers(gl: WebGLRenderingContext): Record<string, WebGLBuffer> {
