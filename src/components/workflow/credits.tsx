...
const GroupedCredits
    : React.FC<{readonly credits: DeepReadonly<IGroupedCredits>}> = props => {
        const { credits } = props;
...
const ImageCreditRow: React.FC<IImageCreditRowProps> = props => {
    const { 
        ...
        resourceCreator, resourceCreatorUrl, creatorSpan, creatorFirst = false,
        retrievedFrom, retrievedFromUrl, siteSpan, siteFirst = false,
        license, licenseSpan, licenseFirst = false
    } = props;
    return (
        <tr>
            {creatorFirst && 
                ...
                readonly group: Record<
                    string, // retrieved from,
                    {
                        ...
                        readonly resources: (readonly
                            [CreditType, string, string, string]
                        )[];
                    }
                >;
            }
